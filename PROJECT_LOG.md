...
- Backend test suite: 172 tests passed excluding the opt-in live PostgreSQL integration test, with 2 framework deprecation warnings. Live Postgres connector and workflow-run persistence checks remain deferred without TEST_DATABASE_URL.
